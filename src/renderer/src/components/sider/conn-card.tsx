...
const drawSvg = async (upload: number, download: number): Promise<void> => {
  ...
  const svg = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 140 36"><image height="36" width="36" href="${trayIconBase64}"/><text x="40" y="15" font-size="18" font-family="PingFang SC" font-weight="bold" text-anchor="start">↑</text><text x="140" y="15" font-size="18" font-family="PingFang SC" font-weight="bold" text-anchor="end">${calcTraffic(upload)}/s</text><text x="40" y="34" font-size="18" font-family="PingFang SC" font-weight="bold" text-anchor="start">↓</text><text x="140" y="34" font-size="18" font-family="PingFang SC" font-weight="bold" text-anchor="end">${calcTraffic(download)}/s</text></svg>`
