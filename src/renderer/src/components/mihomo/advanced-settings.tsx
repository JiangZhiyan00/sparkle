...
const AdvancedSetting: React.FC = () => {
  ...
  const {
    'unified-delay': unifiedDelay = true,
    'tcp-concurrent': tcpConcurrent = true,
    ...
    <SettingCard title="高级设置">
      ...
      <SettingItem title="uTLS 指纹" divider>
        <Select
          size="sm"
          className="w-[150px]"
          selectedKeys={new Set([clientFingerprint])}
          disallowEmptySelection={true}
          onSelectionChange={(v) => {
            onChangeNeedRestart({ 'client-fingerprint': v.currentKey as Fingerprints })
          }}
        >
